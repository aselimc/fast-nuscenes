...
def lidar_to_cam(nusc: NuScenes,
    ...
    for camera in cameras:
        ...
        pcd_camera_frame, global_to_ego_image, ego_to_camera, intrinsic = transform_pointcloud_camera_frame(nusc, pcd, camera_metadata)
        ...
        indices, points = project_into_image(pcd_camera_frame, intrinsic, imsize, normalize, threshold)
...
def transform_pointcloud_camera_frame(nusc: NuScenes,
    ...
    global_to_ego_image = transform_matrix(translation=camera_ego_pose['translation'],
                                        rotation=Quaternion(camera_ego_pose['rotation']),
                                        inverse=True)
